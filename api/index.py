...
def _pa_wsgi_path() -> str:
    ...
    account's display casing (e.g. user "Ferdinand777" ->
    /var/www/ferdinand777_pythonanywhere_com_wsgi.py), so each candidate
    username is lowercased before the path is built.
